...
paramsRadio.addEventListener('click', () => {
    ...
    document.getElementById('parametersBox').style.display = 'block'; // To show parametersBox
})
...
jsonRadio.addEventListener('click', () => {
    ...
    document.getElementById('requestJsonBox').style.display = 'block'; // To show jsonBox
})
...
addParam.addEventListener('click', () => {
    ...
    for (item of deleteParam) {
        item.addEventListener('click', (e) => {
            ...
            // alert('Do you want to delete this particular Parameter?');
